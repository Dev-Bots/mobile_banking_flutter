...
import 'admin_pages_frame.dart';

class DepositToAgent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<TransactionBloc, TransactionState>(
      listener: (context, transactionState) {
        if (transactionState is AdminDepositProcessing) {
          // final snackBar = SnackBar(content: Text("Login in progress"));

          CircularProgressIndicator();
        }

        if (transactionState is AdminDepositSuccess) {
...
class BankImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Image.asset('assets/images/deposit.jpg'),
    );
  }
}
